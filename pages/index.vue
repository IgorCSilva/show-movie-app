...
export default {
  ...
  methods: {
    async getMovies() {
      const data = axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=b2aa182cd510b3825f0fde874abe09bd&language=en-US&page=1`)
